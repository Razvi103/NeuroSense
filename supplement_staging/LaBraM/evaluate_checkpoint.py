...
def compute_szcore_event_metrics(
    ...
    """SzCORE-compliant event-based metrics via the timescoring library."""
    fs = 1.0 / stride_sec
...
def run_eval(args):
    ...
    print(f"\nPost-processing: t_high={args.t_high}, t_low={args.t_low}, "
          f"smooth={args.smooth}s, min_dur={args.min_dur}s")
